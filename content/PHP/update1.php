<?php
/**
 * legacy PAUSATF website source: update1.php.
 *
...
// This script handles the entry of a club number for the entry of primary     *
// contact and paid status  by the PA office.  If the club number is found on  *
// the database, control is transferred to update2.                            *
// ----------------------------------------------------------------------------*
...
// Successful connection.  Check to see if the club number exists.
        ...
        if ($num == 0) {  // if num rows returned 1 or more, club exists
            echo "<p><b>The club number '$cnum' is not on the database.  Must be entered first.";
            exit();
        } else {
           ...
           setcookie (cnum, $cnum); 
           header ("Location: http://www.pausatf.org/PHP/update2.php");  
           exit();
        }
...
<body>   
<center>
<h1><font color="blue">PA Office Update of Club Info</font></h1>
</center> 
<!-- nm_Form -->
