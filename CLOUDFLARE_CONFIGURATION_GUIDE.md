...
A       ftp.pausatf.org     REDACTED_PROD_NEW_IP       Auto    Proxied (orange cloud)
...
curl -X PUT \
  ...
  -H "Authorization: Bearer ${CF_API_TOKEN}" \
  -H "Content-Type: application/json" \
  --data '{"type":"A","name":"www","content":"REDACTED_PROD_NEW_IP","ttl":300,"proxied":true}'
