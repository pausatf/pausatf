...
if (!(strlen($_POST['savepaid'])) > 0) {  // Has screen been updated and returned yet?
    ...
    $cname = $_POST['cname'];
    $mcontact = $_POST['mcontact'];    // get variables from screen
    $mphone = $_POST['mphone'];        // which has been updated by user   
    $email = $_POST['email'];
    ...
    $loc = $_POST['loc']; 
    $spon = $_POST['spon'];
    $twkouts = $_POST['twkouts'];
    $rwkouts = $_POST['rwkouts'];
    $nwsfreq = $_POST['nwsfreq'];
    $savecfocus = $_POST['savecfocus']; 
    $pfocus = $_POST['pfocus'];
    $events = $_POST['events'];
    $comments = $_POST['comments'];
    $savepaid = $_POST['savepaid'];
    if (isset($_POST['cfocus'])) {
        $cfocus = implode (' ', $_POST['cfocus']);
        $_POST['savecfocus'] = $cfocus;
        $savecfocus = $cfocus; 
    } else {
        if (isset($_POST['savecfocus'])) {  
            $cfocus = $savecfocus;
        } else {
            $cfocus = "Not selected";
        } 
...
<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Paid status:</b>&nbsp;<?php echo $savepaid; ?>
<hr>
<!-- nm_Form -->
