...
function _et_core_find_latest( $return = 'path' ) {
	...
	foreach ( $version_files as $version_file ) {
		...
		if ( ! is_file( $version_file ) || str_starts_with( $version_file, $this_core_path ) ) {
			continue;
		}
