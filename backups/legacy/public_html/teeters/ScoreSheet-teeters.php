<?php
  ...
  function get_race_and_club() {
    ...
    $output = mk_header($title, $heading) . mk_form_start('cmd')
      ...
      . "the scorer.<br />\n"
      . "Road scorer is <A href=\"mailto:tlbernhard@comcast.net\">Tom Bernhard</A>, "
...
****/
  ...
  function get_to_emails($series) {
    ...
    $to_emails = array(
          'all' => 'tlbernhard@comcast.net;tct3@pge.com;jeff@teeters.us',
...
//     $mail_log = mail_user($to_all, $subject, $message, $from, false, $test);
    ...
    if($test) {
      ...
      $output = mk_header($title, $heading)
        ...
        . "<br />Road scorer is <A href=\"mailto:tlbernhard@comcast.net\">Tom Bernhard</A>, "
