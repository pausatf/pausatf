...
<body onUnload="javascript:FoundUnload()" onLoad="javascript:FoundLoad()">
<div align="center">
<?php
  if(!$flash_already_shown) {
...
?><img src="/images/youthweba.jpg"> <?php
  }  // close out php if
?>
...
<td bgcolor="#ff0033">
<div align="center">
<table width="800" border="0" cellspacing="2" cellpadding="2" bgcolor="black">
<tr>
<td>
<div align="center">
...
function FoundUnload() {
  alert("Found unload.");
  // do nothing.  But unload event processing seems to be needed to force load when going to new page
}


function FoundLoad() {
  alert("Found load.");
  // do nothing.  But event processing seems to be needed to force load when going to new page
}

function replayFlash() {
  SetCookie('SAW_FLASH', 0, -1);
