...
| systemd `pausatf-db-backup.timer` | Daily on production | Age-encrypted database and legacy-data backup to private DigitalOcean Spaces; recovery wrapper also snapshots deployment/configuration and publishes a verified manifest |
