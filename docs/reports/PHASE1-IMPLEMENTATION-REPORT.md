...
**Issue:** Staging server (REDACTED_DROPLET_ID) had NO firewall protection
...
2. **Create CPU Alert:**
   ...
   - Window: 5 minutes
   - Entities: pausatf-prod (REDACTED_DROPLET_ID)
...
6. **Repeat for Staging Server (REDACTED_DROPLET_ID)**
