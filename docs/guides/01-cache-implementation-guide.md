...
```bash
# On production server (prod.pausatf.org / REDACTED_PROD_NEW_IP)
...
# For PRODUCTION (prod.pausatf.org / REDACTED_PROD_NEW_IP):
...
### Production Server (prod.pausatf.org - REDACTED_PROD_NEW_IP)
**Droplet:** pausatf-prod (DigitalOcean name) / pausatforg20230516-primary (hostname)
...
*For questions: Contact Thomas Vincent (REDACTED_EMAIL)*
