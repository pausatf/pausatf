...
class Option_information {
  ...
  function make_lower_case_name($name) {
    return $name;  // 3-8-2011, modified by Jeff Teeters.  Just use normal club name as stored in database table
...
<UL>
	 ...
	 <LI><font size="2"><a href="https://www.usatf.org/mgmt/clubs/NET/apply.aspx">Direct Link to PA/USATF Club Online Application</a></font></LI>
...
have club #).</font></LI>
	<LI><font size="2"><B><a href="/data/Clubs/startclub.html">Information about how to start a PA Club</a></B></font></LI>
        <LI><font size="2"><B><I>IF YOU HAVE NOT BEEN APPROVED (paid annual dues, and if a youth club, provided required background 
checks) YOUR CLUB WILL NOT APPEAR HERE</I></B></font></LI> 
...
***/
  ...
  function make_club_info_table(&$row) {
    ...
    $wanted_fields = array(
      ...
      'annual_club_events',
      'approved' => $membershipYear . ' Club Approved (USATF fees paid and if a youth club required background checks provided)?',
      'comments');
    $tbl = "<table>\n";
  ...
  function show_club_info($club_no) {
    ...
    if(strtoupper($row['approved']) != 'Y') {
      ...
      $info = "This club is not active.  Either the $membershipYear dues were not paid, or if it is<br />" .
              "a youth club, coaches have not completed the background check.";
    } else {
