...
| `hardening_ssh_max_auth_tries` | Limits SSH authentication attempts. | `6` |
| `hardening_ssh_allow_users` | Explicit list of users allowed to SSH into the server. | See `defaults/main.yml` |
