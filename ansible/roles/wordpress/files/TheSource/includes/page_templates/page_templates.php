...
function et_ptemplates_css(){
	if ( !is_admin() && !(strstr( $_SERVER['PHP_SELF'], 'wp-login.php')) ) {
		wp_enqueue_style( 'magnific_popup', ET_PT_PATH . '/js/magnific_popup/magnific_popup.css', array(), '1.3.4', 'screen' );
...
function et_ptemplates_footer_js(){
	global $themename;
	if ( !is_admin() ) {
		wp_enqueue_script( 'easing', ET_PT_PATH . '/js/jquery.easing-1.3.pack.js', array('jquery'), '1.3.4', true );
		wp_enqueue_script( 'magnific_popup', ET_PT_PATH . '/js/magnific_popup/jquery.magnific-popup.js', array('jquery'), '1.3.4', true );
		wp_enqueue_script( 'et-ptemplates-frontend', ET_PT_PATH . '/js/et-ptemplates-frontend.js', array('jquery','magnific_popup'), '1.1', true );
...
function et_ptemplate_upload_categories_scripts( $hook_suffix ) {
	if ( in_array($hook_suffix, array('post.php','post-new.php')) ) {
		wp_register_script( 'et-ptemplates', ET_PT_PATH . '/js/et-ptemplates.js', array('jquery') );
